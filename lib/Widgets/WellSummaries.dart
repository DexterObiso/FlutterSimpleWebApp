...
class WellSummariesState extends State<WellSummaries> {
  ...
  void initState() {
    super.initState();
    fetchWellSummaryAsync(selectedPadIds, selectedDate);
  }
  ...
  void setSelectedFilterParams(List<int> ids, DateTime date) {
    ...
    fetchWellSummaryAsync(ids, date);
  }

  void fetchWellSummaryAsync(List<int> ids, DateTime date) async {
    fetchWellSummaries(ids, date).then((value) => setState(
          () {
            wellSummaries = value;
                              ...
                              child: Table(
                                ...
                                children: [
                                  TableRow(children: [
                                    Text(
                                      'CYC: ' +
                                          item.cycle_Number_Rounded.toString(),
                                    ...
                                    Text(
                                      'WHS: ' +
                                          item.well_Head_Status.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                  ]),
                                  TableRow(children: [
                                    Text(
                                      'SIC: ' +
                                          item.shut_In_Code_Rounded.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                    Text(
                                      'MOTOR STATUS: ' +
                                          item.motor_Status.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                    Text(
                                      'W/H TEMP: ' +
                                  ...
                                  TableRow(children: [
                                    Text(
                                      'CASING PRESS: ' +
                                          item.casing_Press_Rounded.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                    Text(
                                      'VNT STA: ' + item.vent_Status.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                    Text(
                                      'BN SZ: ' + item.bean_Size.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                  ]),
                                  TableRow(children: [
                                  ...
                                  TableRow(children: [
                                    Text(
                                      'TEST FLUID: ' +
                                          item.test_Fluid_Rounded.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                    Text(
                                      'TEST DATE: ' +
                                  ...
                                  TableRow(children: [
                                    Text(
                                      'TEST TYPE: ' +
                                          item.well_Test_Type.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                    Text(
                                      'TQ: ' + item.test_Quality.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                    Text(
                                      'PROD DAY: ' +
                                  ...
                                  TableRow(children: [
                                    ...
                                    Text(
                                      'OIL UPLIFT: ' +
                                          item.oil_Volume_Rounded.toString(),
                                      style: TextStyle(fontSize: 11),
                                    ),
                                  ])
                                ],
